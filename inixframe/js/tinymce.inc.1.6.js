...
//    safari,pagebreak,style,table,advimage,advlink,inlinepopups,media,contextmenu,paste,fullscreen,xhtmlxtras,preview
	default_config = {
		selector: ".rte" ,
		plugins : "colorpicker link image paste pagebreak table contextmenu ajaxfilemanager table code media autoresize textcolor",
		...
		toolbar2: "",
		external_filemanager_path: ad+"/ajaxfilemanager/",
		filemanager_title: "File manager" ,
		external_plugins: { "filemanager" : ad+"/ajaxfilemanager/plugin.min.js"},
		language: iso,
		skin: "prestashop",
		statusbar: false,
		relative_urls : false,
