...
{if isset($conf) }
    ...
    <p class="info">{l s='You can use the code bellow to get 30%% discount on your next purchase from ' mod='inixframe'}{$author}</p>
...
<p class="feedback_thanks">
    <a href="http://www.{$author_domain}" target="_blank"><img src="http://{$author_domain}/inixframe_assets/logo_wider.png" /></a>
</p>
