...
<html>
	<head>
		<meta charset="UTF-8">
		<title>{l s='Invalid security token' mod='inixframe'}</title>
		<style>
			body{
	...
	<body>
		<div class="container">
			<div class="error-msg">
				...
				{l s='Invalid security token' mod='inixframe'}
			</div>
			<div class="action-container">
				<a class="btn btn-continue" href="{$url}">
					{l s='I understand the risks and I really want to display this page' mod='inixframe'}
				</a>
				<a class="btn btn-cancel" href="index.php">
					{l s='Take me out of here!' mod='inixframe'}
				</a>
			</div>
		</div>
	</body>
