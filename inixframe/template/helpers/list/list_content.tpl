			...
			{block name="td_content"}
				...
				{if isset($tr.$key)}
					...
					{elseif isset($params.activeVisu)}
						{if $tr.$key}
							 <i class="icon-check-ok"></i> {l s='Enabled' mod='inixframe'}
						{else}
							<i class="icon-remove"></i> {l s='Disabled' mod='inixframe'}
						{/if}
	...
	<tr>
		<td class="list-empty" colspan="{count($fields_display) + 2}">
			<div class="list-empty-msg">
				...
				{l s='No records found' mod='inixframe'}
			</div>
		</td>
	</tr>
{/if}
