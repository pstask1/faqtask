        ...
        <div class="portlet-body">
            <div class="row">
                <div class="col-lg-2  margin-top-20">
                    ...
                    <a class="thumbnail">
                        <img src="http://{$author_domain}/inixframe_assets/logo_vert.png" width="200px"/>
                    </a>
                ...
                <div class="col-lg-10">
                    ...
                    <p>
                        ...
                        services.
                        {$author} Consulting offers a range of services to suit the needs of our customers, including:
                        Prestashop Design and Development, Consulting and Analytics.
                    </p>

                    <p>For the latest modules & feature updates, please visit: <a href="http://www.{$author_domain}">www.{$author_domain}</a>
                    </p>

                    <p>Prestashop your module <a
                                href="http://www.{$author_domain}/content/6-prestahop-your-module">here</a></p>
