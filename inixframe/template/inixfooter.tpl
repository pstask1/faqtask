            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>The module is named <strong>{$author} Dashboard</strong> and the folder is called <stgrong>inixframe</stgrong></p>
                        ...
                        <p>And all that <strong>free of charge!</strong>. You just need to go and install <strong>{$author} dashboard</strong> </p>
                    ...
                    <div class="modal-footer">
                        ...
                        {if version_compare(_PS_VERSION_ ,'1.7.0.0','<')}
                            <a href="{$link->getAdminLink('AdminModules')}&tab_module=other&module_name=inixframe"
                               class="btn btn-primary">Install {$author} Dashboard</a>
                        {else}
    ...
    <div class=" moduleFooter">
        ...
        <div class="visit right">
            <a href="http://www.{$author_domain}" target="_blank">
                Visit <img src="http://{$author_domain}/inixframe_assets/logo_wide_white.png" height="40px"/></a>
        ...
        <div class="faq right">
            <a href="http://{$author_domain}/faq/1-faq" target="_blank">{l s='FAQ' mod='inixframe'}</a>
        </div>
    </div>
    <script type="text/javascript">
