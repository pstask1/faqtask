...
<div class="form-group col-lg-6" >
    <select  name="search_category" id="faq_control" class="form-control faq-control" onchange="location.href=$(this).val()" style="height: 34px;">
    ...
    <div class="input-group col-lg-6">
        ...
        <span class="input-group-btn">
            <button id="submitSearch" class="btn btn-default" type="submit" name="submitSearch" style="height: 32px;color: black; padding: 9px;"><i class="icon-search" ></i> {l s='Search' mod='faqextra'}</button>
        </span>
    </div>
</form>
{if isset($search_result) && !empty($search_result)}
...
{elseif !isset($search_result)}
    {if isset($faq_category)}
        ...
        {if isset($faq_pages) && !empty($faq_pages)}
            <div class="panel-group col-lg-12 ps17-accordion" id="accordion">
